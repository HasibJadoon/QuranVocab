...
import { McitContractFieldComponent } from './contract-field.component';
...
@NgModule({
  ...
  declarations: [McitContractFieldComponent],
  exports: [McitContractFieldComponent]
})
export class McitContractFieldModule {}
